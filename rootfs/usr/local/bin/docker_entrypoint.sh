...
# Make sure volume '/usr/lib/unifi/data' is mounted and writeable
if [[ ! -d /usr/lib/unifi/data ]]; then
    echo -e "\nError: volume '/usr/lib/unifi/data' is not mounted.\n" >&2
    exit 1
...
# Fix user and group ownerships for '/usr/lib/unifi/data'
